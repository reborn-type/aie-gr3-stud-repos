...
Важно! Что перед запуском сервиса нужно запустить обучение модели и после ее обучения и сохранения можно запустить сервис, поскольку выгружая с гит модель не будет изначально лежать в artifacts. (Ограничения по весу файла)
